...
class AllNamesSelectionScreen extends StatefulWidget {
  const AllNamesSelectionScreen({super.key});

  @override
  _AllNamesSelectionScreenState createState() =>
      _AllNamesSelectionScreenState();
}

class _AllNamesSelectionScreenState extends State<AllNamesSelectionScreen> {
  NamesBloc? namesBloc;
